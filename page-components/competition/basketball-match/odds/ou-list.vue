...
const COLUMNS_LIST = [
  { title: '公司', key: 'companyName', width: 120 },
  {
    ...
    width: 360,
    children: [
      { title: '大分', key: 'bi', width: 120 },
      { title: '盘口', key: 'ti', width: 120 },
      { title: '小分', key: 'si', width: 120 },
    ],
  },
  {
    title: '即时',
    ...
    width: 360,
    children: [
      { title: '大分', key: 'b', width: 120 },
      { title: '盘口', key: 't', width: 120 },
      { title: '小分', key: 's', width: 120 },
    ],
  },
...
export default {
  ...
  methods: {
    onSocketMessage() {
      emitter.$on('socket-basketball-ou', this.changeOriginData)
    },
    offSocketMessage() {
      emitter.$off('socket-basketball-ou', this.changeOriginData)
    },
    ...
    fetchOuList() {
      ...
      this.$axios
        .get(api.get.basketball.fetchMatchOu, {
          params: {
