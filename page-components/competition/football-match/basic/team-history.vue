  ...
  <div class="match-basic-team-history">
    ...
    <div v-loading="loading" class="home-team-history">
      <div class="team-tilte">
        <img v-lazy="matchInfo.home.icon" class="team-title-icon" />
        <span class="team-title-name">{{
          matchInfo.home.name_js || matchInfo.home.name
        }}</span>
      </div>
      <HistoryTable
    ...
    <div v-loading="loading" class="guest-team-history">
      <div class="team-tilte">
        <img v-lazy="matchInfo.guest.icon" class="team-title-icon" />
        <span class="team-title-name">{{
          matchInfo.guest.name_js || matchInfo.guest.name
        }}</span>
      </div>
      <HistoryTable
        :cur-team-id="Number(matchInfo.guest_team_id)"
      ...
      return this.$axios
        ...
        .then(({ code, data, msg }) => {
          ...
          return matches.map(item => ({
            ...
            ...fetchTeamIsWin(item.home_team_id, opt.team_id, item.result),
          }))
        })
        .catch(() => {
          return []
