...
const COLUMNS_LIST = [
  { title: '', width: 115, key: 'title', border: true },
  { title: '', width: 57, key: 'type', border: true },
  { title: '主胜', width: 90, key: 'w' },
  { title: '平局', width: 90, key: 'd' },
  { title: '客胜', width: 90, key: 'l' },
  { title: '返还率', width: 90, key: 'returnRate', border: true },
  { title: '主胜率', width: 90, key: 'wRate' },
  { title: '平局率', width: 90, key: 'dRate' },
  { title: '客胜率', width: 90, key: 'lRate', border: true },
  { title: '凯利指数', width: 150, key: 'kelly' },
]
...
const KELLY_KEYS = ['wKelly', 'dKelly', 'lKelly']
