<template>
  <div class="home-experts">
    <FirstExpert :info="formatData(firstInfo)" />

    <div class="home-experts__list">
      <Item
        v-for="item of expertsList"
        :key="item.uid"
        class="home-experts__item"
...
import Item from '../../exchange/bbs/bbs-list-item'
import FirstExpert from './first'
...
.home-experts {
  ...
  .home-experts__item {
    width: 261px;
    box-shadow: rgba(51, 51, 51, 0.05) 0px 0px 4px 0px;
    border-radius: 8px;
    margin-bottom: 8px;
  }
}
