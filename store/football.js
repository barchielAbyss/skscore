...
const CONTINENT_EVENT_IDS = [
  { id: 1101, uid: 1, name: '欧洲' },
  { id: 1102, uid: 2, name: '美洲' },
  { id: 1103, uid: 3, name: '亚洲' },
  { id: 1104, uid: 4, name: '大洋洲/非洲' },
  { id: 1105, uid: 5, name: '其他赛事' },
]
...
export const actions = {
  ...
  FetchCountryEventList({ state, dispatch }) {
    ...
    return Promise.resolve(
      this.$axios
        .get(api.get.football.fetchCountryEventList)
        .then(({ data }) => {
